...
DATA_DIR = "/Users/niruba/Desktop/Images"  #Please adjust here to load dataset
IMG_SIZE = (224, 224)
CHANNELS = 3
BATCH_SIZE = 32  
NUM_CLASSES = 120
...
# This function is to create InceptionV3-based model
...
if __name__ == "__main__":
    ...
    # Callbacks
    checkpoint = ModelCheckpoint("InceptionV3model.keras", monitor="val_loss", save_best_only=True, verbose=1)
